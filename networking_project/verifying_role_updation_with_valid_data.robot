...
*** Test Cases ***
verifying_role_updation_with_valid_data
    ...
    Wait Until Page Contains    manag1    30
    ...
    Sleep    10
    Input Text    xpath=//*[@id="editrolename"]    managers1
    sleep    5
    ...
    Reload Page
    Wait Until Page Contains Element    xpath=//*[@id="datatable-responsive_filter"]/label/input    30
    Input Text    xpath=//*[@id="datatable-responsive_filter"]/label/input    managers1
    Wait Until Page Contains    managers1    30
