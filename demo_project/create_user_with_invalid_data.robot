...
create_user_with_invalid_data
    ...
    sleep    10
    Input Text    id:firstname    sal7293
    Input Text    id:lastname    emp
    Input Text    id:email    sal7293
    Input Text    id:empno    7293
    ...
    Wait Until Page Contains Element    xpath=//*[@id="datatable-responsive_filter"]/label/input    30
    sleep    10
    Input Text    xpath=//*[@id="datatable-responsive_filter"]/label/input    sal7293
    Wait Until Page Contains    sal7293    30
